...
public class TimeEvaluation {
  ...
  public void setupPageRank(Model model) {
    ...
    long tac = System.currentTimeMillis();
    System.out.println(
        "Total Execution  of PageRank time is " + ((tac - tic) / 1000d) + " seconds");
  ...
  public void setupParallelPageRank(Model model) {
    ...
    long tac = System.currentTimeMillis();
    System.out.println(
        "Total Execution  Parallel PageRank  time is " + ((tac - tic) / 1000d) + " seconds");
  ...
  public void setupParallelHARE(Model model) {
    ...
    long tac = System.currentTimeMillis();
    System.out.println(
        "Total Execution Parallel HARE  time is " + ((tac - tic) / 1000d) + " seconds");
